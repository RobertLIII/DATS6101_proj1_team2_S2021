...
The concept that location and home attributes correlate with housing prices could reasonably apply broadly and internationally. 
...
## 2.3 Summary of Price Statistics
...
## 2.10 Price by Number of Rooms (<10 Rooms)
...
## 2.12 Test of Independence by Group (Pearson $\chi^2$)
...
## 2.14 Transform Data - Homogeneity                                                    
...
## 3.3 Linear Model 4: Removed Land Size
...
![ ](/Users/robertlong/Documents/Education/Math/Graduate/Data Science - D6101/Midterm_project/images/proposed_model.png)
