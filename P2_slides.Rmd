...
```{r coef in lasso regression, results='markup'}
...
From the coefficient of lasso regression model, the variables of `Rooms`, `Type`, `Distance`, `Postcode`,  `Bathroom`, `YearBuilt`, `Lattitude`, and `Longtitude` are related with responsive variable `Price`.


# Lasso Results

```{r lasso fit and predict, include=TRUE, results='markup'}
set.seed(999)
